...
function mode(arr) {
  ...
  return Number(Object.keys(obj).reduce(function(a, b){ return obj[a] > obj[b] ? a : b }));
  }
...
function fewestStudents(arr) {
  ...
  let biggestClass;
  for (let i of arr) {
    if (i.numberOfStudents < biggest) {
      biggest = i.numberOfStudents;
      biggestClass = i;
    }
  }
  return biggestClass;
